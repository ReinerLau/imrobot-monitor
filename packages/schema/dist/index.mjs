...
import { bigint as bigint2, int as int2, json, mysqlTable as mysqlTable2 } from "drizzle-orm/mysql-core";
var behavior = mysqlTable2("behavior", {
  id: int2("id").autoincrement().primaryKey(),
  time: bigint2("time", { mode: "number" }).notNull(),
  data: json("data").notNull()
});

// src/schema/errors.ts
import { bigint as bigint3, int as int3, mysqlTable as mysqlTable3, text } from "drizzle-orm/mysql-core";
...
import { bigint as bigint4, int as int4, json as json2, mysqlTable as mysqlTable4 } from "drizzle-orm/mysql-core";
var screen = mysqlTable4("screen", {
  id: int4("id").autoincrement().primaryKey(),
  time: bigint4("time", { mode: "number" }).notNull(),
